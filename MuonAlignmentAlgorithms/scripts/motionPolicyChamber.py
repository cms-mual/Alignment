...
print "about to run execfile(theInREPN): ", theInREPN
execfile(theInREPN)


def loopover(muSystem):

  print "starting loopover", muSystem
  movedChamberKeys = []
...
print "AR: before loopover for final xml", theOutXML

if DO_DT: loopover("DT")
if DO_CSC: loopover("CSC")

print "AR: about to output the final xml", theOutXML
