...
if(len(sys.argv) < 1):
  print "USAGE python mc_DT_layer_plots.py ../mc_DT-1100-111111_CMSSW_8_0_17_ideal_45M_8TeV_Layer_v2_03/mc_DT-1100-111111_CMSSW_8_0_17_ideal_45M_8TeV_Layer_v2_03.root -b"; sys.exit(0);
filename = sys.argv[1]
