...
#xmlfileAPE        = "Geom/APEs_COVfromHSimranjit_DT_Data_AllContributions_AllTypesOfApes_6DOF_MCfromHW.xml"
g_ape1 = MuonGeometry(xmlfileAPE1)
g_ape2 = MuonGeometry(xmlfileAPE2)
g_apes = []; g_apes.append(g_ape1); g_apes.append(g_ape2)
#myText="Circle: My APE from Histos; Cross: Simranjit's APE (both w/o signconv.)"
myText="Circle: My APE from Histos; Cross: My APE from MINUIT"
