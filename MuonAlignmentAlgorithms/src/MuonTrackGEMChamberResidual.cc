/* 
 * $Id: MuonTrackGEMChamberResidual.cc,v 1.3 2011/11/02 19:58:38 khotilov Exp $
 */

#include "Alignment/MuonAlignmentAlgorithms/interface/MuonTrackGEMChamberResidual.h"
//#include "Geometry/GEMGeometry/interface/GEMGeometry.h"

MuonTrackGEMChamberResidual::MuonTrackGEMChamberResidual(edm::ESHandle<GlobalTrackingGeometry> globalGeometry,
...
void MuonTrackGEMChamberResidual::setSegmentResidual(const reco::MuonChamberMatch *trk,
  ...
  if (segmentGEM.get() != nullptr) {
    ...
    m_chi2 = segment->chi2();
    //std::cout<<"GEM seg position = "<<segment->localPosition()<<"  numhits="<<m_numHits<<"  id: "<<id<<std::endl;
  }
  ...
  std::cout<<"GEMres="<<m_residual<<"  dx="<<trk->x-seg->x<<"  diff="<<trk->x-seg->x - m_residual<<std::endl;
  */
  ...
  //std::cout<<"GEM res "<<m_residual<<"+-"<<m_residual_error<<"  "<<m_resslope<<"+-"<<m_resslope_error<<"  "<<trk->y-seg->y<<"+-"<<yresidual_error<<"  "<<trk->dYdZ - seg->dYdZ<<"+-"<<yresslope_error<<std::endl;
  //std::cout<<"GEM trk "<<m_trackx<<" "<<m_tracky<<" "<<m_trackdxdz<<" "<<m_trackdydz<<std::endl;
  //std::cout<<"GEM seg "<<m_segx<<" "<<m_segy<<" "<<m_segdxdz<<" "<<m_segdydz<<std::endl;
}
